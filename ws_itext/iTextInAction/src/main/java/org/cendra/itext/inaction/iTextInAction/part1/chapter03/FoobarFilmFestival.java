...
//		BaseFont bf_times = BaseFont.createFont("c:/windows/fonts/times.ttf", BaseFont.WINANSI, BaseFont.EMBEDDED);
		BaseFont bf_times = BaseFont.createFont("/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf", BaseFont.WINANSI, BaseFont.EMBEDDED);
		...
		document.add(new Paragraph("Ascent Helvetica: " + bf_helv.getAscentPoint(foobar, 12)));
		document.add(new Paragraph("Ascent Times: " + bf_times.getAscentPoint(foobar, 12)));
		document.add(new Paragraph("Descent Helvetica: " + bf_helv.getDescentPoint(foobar, 12)));
		document.add(new Paragraph("Descent Times: " + bf_times.getDescentPoint(foobar, 12)));
		document.add(Chunk.NEWLINE);
		// Kerned text
