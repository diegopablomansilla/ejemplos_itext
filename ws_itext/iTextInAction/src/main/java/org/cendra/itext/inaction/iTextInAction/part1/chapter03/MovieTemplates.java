...
public class MovieTemplates extends MovieCalendar {
	...
	public void createPdf(String filename) throws IOException, DocumentException {
		...
		try {
			...
			PdfTemplate t_under = under.createTemplate(PageSize.A4.getHeight(), PageSize.A4.getWidth());
			drawTimeTable(t_under);
			PdfTemplate t_over = over.createTemplate(PageSize.A4.getHeight(), PageSize.A4.getWidth());
