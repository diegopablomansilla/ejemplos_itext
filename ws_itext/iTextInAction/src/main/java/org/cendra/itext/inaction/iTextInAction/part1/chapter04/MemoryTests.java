...
package org.cendra.itext.inaction.iTextInAction.part1.chapter04;
...
public class MemoryTests {
	...
	/**
	 * Create two PDFs, one without memory management, one with. Write a report file to show the memory usage
	 */
	 ...
	 * 
	 * @param writer
	 *            the writer to our report file
	 * @param filename
	 *            the PDF that will be created
	 * @throws IOException
