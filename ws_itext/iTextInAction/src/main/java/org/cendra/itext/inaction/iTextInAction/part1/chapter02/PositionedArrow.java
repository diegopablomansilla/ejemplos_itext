...
/**
 * Subclass of VerticalPositionMark that draws an arrow in the left or right margin.
 */
public class PositionedArrow extends VerticalPositionMark {
	 ...
	 * 
	 * @param left
	 *            if true, an arrow will be drawn on the left; otherwise, it will be drawn on the right.
	 * @throws IOException
	 ...
	 * 
	 * @see com.itextpdf.text.pdf.draw.VerticalPositionMark#draw(com.itextpdf.text.pdf.PdfContentByte, float, float, float, float, float)
	 */
