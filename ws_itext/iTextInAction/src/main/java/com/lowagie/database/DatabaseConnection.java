...
/**
 * This is a helper class to access the database that comes with the book
 * samples.
 */
...
public abstract class DatabaseConnection {
	 ...
	 * 
	 * @param query
	 *            the query that will be used to create a prepared statement.
	 * @return a statement
	 * @throws SQLException
	 */
	 ...
	 * 
	 * @param expression
	 *            an SQL expression (CREATE, DROP, INSERT, UPDATE)
	 */
