...
/**
 * This is a helper class to access an hsqldb database. The database scripts are
 * supposed to be present in directory: resources/db
 */
public class HsqldbConnection extends DatabaseConnection {
	...
	public HsqldbConnection(String db_file_name_prefix) throws SQLException {
		...
		connection = DriverManager.getConnection("jdbc:hsqldb:resources/db/"
