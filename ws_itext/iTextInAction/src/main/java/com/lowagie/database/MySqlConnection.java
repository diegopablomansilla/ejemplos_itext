...
/**
 * This is a helper class to access a mySql database. The username and password
 * of the database are supposed to be present in a properties file mysql.props
...
public class MySqlConnection extends DatabaseConnection {
	...
	public MySqlConnection(String database) throws SQLException {
		...
		connection = DriverManager.getConnection("jdbc:mysql://localhost/"
				+ database, credentials.getProperty("username"),
