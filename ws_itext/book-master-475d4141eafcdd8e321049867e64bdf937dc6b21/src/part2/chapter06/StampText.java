...
public class StampText {
	...
	public static void stamp(String src, String dest) throws IOException, DocumentException {
		...
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase("Hello peoplexxxxxxxxxxxxxxxxxxxxxxxx!"), 36, 540, 0);
		stamper.close();
		reader.close();
	}
	...
	public static void stampIgnoreRotation(String src, String dest) throws IOException, DocumentException {
		...
		PdfContentByte canvas = stamper.getOverContent(1);
		ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase("Hello peoplexxxxxxxxxxxxxxxxxxxxxxxxxxx!"), 36, 540, 0);
		stamper.close();
		reader.close();
	}
}
